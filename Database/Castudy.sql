...
from khach_hang hop_dong_chi_tiet
...
select kh.ma_khach_hang, kh.ho_ten, lk.ten_loai_khach, hd.ma_hop_dong, dv.ten_dịch_vu, hd.ngay_lam_hop_dong, 
       hd.ngay_ket_thuc, (dv.chi_phi_thue + IFNULL(SUM(hdct.so_luong * dvdk.gia), 0)) as tong_tien
from khach_hang kh
...
select dv.ma_dich_vu, dv.ten_dịch_vu, dv.dien_tich, dv.chi_phi_thue, ldv.ten_loai_dich_vu
from dich_vu dv
...
select * from dich_vu;
select dv.ma_dich_vu,  dv.ten_dịch_vu, dv.dien_tich, dv.so_nguoi_toi_da, dv.chi_phi_thue, dv, ldv.ten_loai_dich_vu
from dich_vu dv
join loai_dich_vu ldv on dv.ma_loai_dich_vu = ldv.ma_loai_dich_vu
join hop_dong hd2020 on dv.ma_dich_vu= hd2020.ma_dich_vu
and year(hd2020.ngay_lam_hop_dong) = 2020
left join hop_dong hd2021 on dv.ma_dich_vu = hd2021.ma_dich_vu
and year(hd2021.ngay_lam_hop_dong) = 2021
